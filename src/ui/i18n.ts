...
const EN = {
  ...
  'options.steadyCam': 'Steady camera',
  ...
  'controls.sheet': 'Your build',
  'controls.sheet.how': 'Tab',
  ...
  'boon.rod-special.desc': 'Your Special echoes — another, weaker strike a beat later. Stacks.',
  ...
  'sheet.slot.cast': 'Cast',
  'sheet.plain': 'nothing — plain damage',
  /** Named rather than merely greyed: the player has to be told what lapsed. */
  'sheet.overruled': 'overruled — a later card took {slots}',
  'sheet.close': 'TAB closes',

  'sheet.hp': 'Health',
  'sheet.attack': 'Attack damage',
  'sheet.special': 'Special damage',
  'sheet.cast': 'Cast damage',
  'sheet.attackSpeed': 'Attack speed',
  'sheet.reach': 'Attack reach',
  'sheet.move': 'Movement',
  'sheet.crit': 'Critical chance',
  'sheet.critMul': 'Critical damage',
  'sheet.lifesteal': 'Lifesteal',
  'sheet.ammo': 'Cast ammo',
  'sheet.attackPierce': 'Attack pierce',
  'sheet.castPierce': 'Cast pierce',
  ...
  'hammer.twin-special.desc': 'Your Special echoes — another, weaker strike a beat later. Stacks.',
...
const PL: Partial<Record<Key, string>> = {
  ...
  'options.steadyCam': 'Spokojna kamera',
  ...
  'boon.rod-special.desc': 'Twoja Umiejętność powtarza się — kolejne, słabsze uderzenie chwilę później. Kumuluje się.',
  ...
  'sheet.move': 'Ruch',
  'sheet.crit': 'Szansa na krytyka',
  'sheet.critMul': 'Obrażenia krytyczne',
  'sheet.lifesteal': 'Kradzież życia',
  'sheet.ammo': 'Ładunki Czaru',
  'sheet.attackPierce': 'Przebicie Ataku',
  'sheet.castPierce': 'Przebicie Czaru',
  ...
  'hammer.twin-special.desc': 'Twoja Umiejętność powtarza się — kolejne, słabsze uderzenie chwilę później. Kumuluje się.',
